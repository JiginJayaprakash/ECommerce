...
import { ChevronDownIcon, EnvelopeOpenIcon, PlayCircleIcon, HomeModernIcon } from '@heroicons/react/20/solid'

const solutions = [
    { name: 'Home', description: '', href: '/', icon: HomeModernIcon },
]
const callsToAction = [
    { name: 'github', href: 'https://github.com/JiginJayaprakash/ECommerce', icon: PlayCircleIcon },
    { name: 'Contact', href: 'mailto:jayaprakash.jigin@gmail.com', icon: EnvelopeOpenIcon },
]
                                        ...
                                        {solutions.map((item) => (
                                            <div key={item.name} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
                                                <div className="mt-1 flex h-3 w-3 flex-none items-left justify-left rounded-lg bg-gray-50 group-hover:bg-white">
                                                    <item.icon className="h-6 w-3 text-gray-600 group-hover:text-indigo-600" aria-hidden="true" />
                                                </div>
                                                <div>
